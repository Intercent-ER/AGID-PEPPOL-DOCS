@echo off
cls
echo PEPPOL BIS Billing 3.0 (EN-16931) - UBL-CreditNote-2.1 two-phase validation
set "xml="
call _fc xml
...
echo   - EN \ Italian CIUS Rules
call _xslt2 "%xml%" xsl\PEPPOL\3.0\ITNAT-EN16931-UBL.xsl output\svrl_report.xml
