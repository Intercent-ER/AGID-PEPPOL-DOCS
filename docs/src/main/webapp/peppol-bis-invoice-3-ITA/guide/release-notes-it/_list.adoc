link:pass:[${peppoldocs.root.url}/my_index_fatt.jsp][Vai al Portale Specifiche]
...
| 3.0.21(IT)
a| 20/05/2026
a| _Aggiornamento alle specifiche https://docs.peppol.eu/poacc/billing/3.0/upcoming/release-notes/[Peppol BIS 3.0.21 - May release 2026]_. +

Entrata in vigore *lunedì 17 Agosto 2026*

[red]#Cambiamenti alla documentazione# +

* Correzione della denominazione «Peppol» al posto di «PEPPOL» nei testi della guida;
* Aggiunto il profilo 02 «Fatturazione con risposta» (ProfileID `urn:peppol:bis:billing_with_response`);
* Aggiornamento dei link alla documentazione Peppol e al registro EN 16931;
* Aggiornamento della tabella 19 EN 16931 (regole CEN) e delle tabelle delle regole Peppol;
* Sincronizzazione delle codifiche EAS, ICD e ISO 4217;
* Aggiunta di `LocalId` e `LocalName` nella codifica UN/ECE Rec 20 (ITA).

[red]#Cambiamenti alle code lists e artefatti di validazione# +

* Electronic Address Scheme (EAS): rimossi codici errati; aggiornate descrizioni; aggiunti 0246, 0248;
* ISO 6523 ICD list: aggiunti 0246, 0247, 0248; aggiornate descrizioni;
* ISO 4217 Currency codes: rimossi ANG, BGN; aggiunto XCG;
* Regole PEPPOL-EN16931-P0100 e PEPPOL-EN16931-P0101 aggiornate per il profilo 02;
* Regole PEPPOL-COMMON-R052 e PEPPOL-COMMON-R053 da «warning» a «fatal»;
* Regola DK-R-017 (Danimarca) da «warning» a «fatal»;
* Nuove regole PEPPOL-COMMON-R054–R057 (Paesi Bassi);
* Regola PEPPOL-EN16931-R004 aggiornata (CustomizationID senza versione);
* Rimossa regola BR-CO-25 dallo schematron CEN.

| 3.0.20.1(IT)
a| 15/12/2025
a| _Aggiornamento alle specifiche https://docs.peppol.eu/poacc/billing/3.0/2025-Q4/[PEPPOL BIS 3.0.20 - November release 2025] e altre modifiche italiane_. +

Entrata in vigore *lunedì 23 Febbraio 2026*
...
** Aggiunti: 0244 
* ISO 6523 ICD list 
** Aggiunti: 0241,0242,0243,0244 
* ISO 4217 Currency codes 
** Rimossi: STN 
** Aggiunti: CNH,STD 
* VATEX code list 
** Aggiunti: VATEX-EU-135-1 
* Introduzione delle regole PEPPOL-COMMON-R052 (Danimarca) e PEPPOL-COMMON-R053 (Danimarca) con severità “warning” valide per fatture emesse da fornitori danesi. 
* Aggiornamento del testo della regola DK-R-010 (Danimarca); 
* Introduzione della regola danese DK-R-017 (Danimarca) con severità “warning” valida per fatture emesse da fornitori danesi verso clienti danesi.  

[red]#Aggiornamento schematron EN 16931# +

* Aggiornamento schematron EN 16931 
* Eliminazione regola UBL-CR-631. 

| 3.0.19.1(IT)
a| 06/06/2025
a| _Aggiornamento alle specifiche https://docs.peppol.eu/poacc/billing/3.0/2024-Q4/release-notes/[PEPPOL BIS 3.0.19 - May release 2025] e altre modifiche italiane_. +
...
* Electronic Address Scheme (EAS);
** Rimosso: 9901
** Aggiunto: 0147,0154,0158,0170,0194,0203,0205,0217,0225,0240 
* ISO 6523 ICD list;
** Aggiunto: 0239,0240 
* ISO 4217 Currency codes;
** Rimosso: CUC,ZWL 
