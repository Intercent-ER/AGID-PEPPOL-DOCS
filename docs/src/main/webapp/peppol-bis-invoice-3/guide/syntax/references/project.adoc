...
.Esempio UBL example per il riferimento al progetto (CUP) in una fattura
[source, xml, indent=0]
----
...
Per riferirsi a più progetti (CUP) dalle righe di fattura è necessario utilizzare 'cac:AdditionalDocumentReference' con il codice tipo documento = 130.
