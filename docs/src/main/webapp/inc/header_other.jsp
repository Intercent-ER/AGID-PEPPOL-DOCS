						...
						<li class="btn-group" id="peppol-bis">
							...
							<ul class="dropdown-menu">
								...
								<li class="dropdown">
									...
									<%@include file="../peppol-bis-3/menu/syntax-menu.html" %>
								</li>
								...
								<li class="dropdown">
									...
									<%@include file="../peppol-bis-3/menu/rule-menu.html" %>
								</li>
								...
								<li class="dropdown">
									...
									<%@include file="../peppol-bis-3/menu/codelist-menu.html" %>
								...
								<li class="dropdown dropdown-agid">
									...
									<%@include file="../peppol-bis-3/menu/stylesheet-menu.html" %>
								</li>
							</ul>
						</div>
					</div>
