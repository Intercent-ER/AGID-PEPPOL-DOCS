...
Di seguito il link:pass:[${peppoldocs.root.url}/xml/ITA/peppol-bis-invoice-3/codelist/TipoDocumento%20FatturaPA.html][link] alla codelist italiana contenente i codici di Tipo Documento.
