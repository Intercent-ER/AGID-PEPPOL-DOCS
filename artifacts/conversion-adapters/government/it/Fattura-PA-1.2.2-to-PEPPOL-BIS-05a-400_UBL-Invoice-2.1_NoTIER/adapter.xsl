...
<xsl:stylesheet xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:in="http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.2" xmlns:ccts="urn:un:unece:uncefact:documentation:2" xmlns:cr="http://www.ubl-italia.org/ns/CrossReference" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:ext="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2" xmlns="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:asmap="http://www.javest.com/ns/mapper/snippet/attribute" xmlns:xsmap="http://www.javest.com/ns/mapper/snippet" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="xsmap asmap in ds" version="2.0">
...
-->
	...
	<xsl:template match="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiContratto" mode="EstremiContratto_Riga">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
	...
	<xsl:template match="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiConvenzione" mode="EstremiConvenzione_Riga">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<xsl:if test="RiferimentoNumeroLinea[normalize-space()]=$CN/NumeroLinea[normalize-space()]">
			<cac:DocumentReference>
	...
	<xsl:template match="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiConvenzione/CodiceCIG" mode="CIG_Convenzione_Riga">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<xsl:if test="../RiferimentoNumeroLinea[normalize-space()]=$CN/NumeroLinea[normalize-space()]">
			<cac:DocumentReference>
	...
	<xsl:template match="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiConvenzione/CodiceCUP" mode="CUP_Convenzione_Riga">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<xsl:if test="../RiferimentoNumeroLinea[normalize-space()]=$CN/NumeroLinea[normalize-space()]">
			<cac:DocumentReference>
	...
	<xsl:template match="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiFattureCollegate" mode="BillingLineReference">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<xsl:if test="RiferimentoNumeroLinea[normalize-space()]=$CN/NumeroLinea[normalize-space()]">
	...
	<xsl:template match="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiFattureCollegate/CodiceCIG" mode="CIG_FattureCollegate_Riga">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<xsl:if test="../RiferimentoNumeroLinea[normalize-space()]=$CN/NumeroLinea[normalize-space()]">
			<cac:DocumentReference>
	...
	<xsl:template match="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiFattureCollegate/CodiceCUP" mode="CUP_FattureCollegate_Riga">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<xsl:if test="../RiferimentoNumeroLinea[normalize-space()]=$CN/NumeroLinea[normalize-space()]">
			<cac:DocumentReference>
	...
	<xsl:template match="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiFattureCollegate/CodiceCommessaConvenzione" mode="CodiceCommessaConvenzione_FattureCollegate_Riga">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<xsl:if test="../RiferimentoNumeroLinea[normalize-space()]=$CN/NumeroLinea[normalize-space()]">
			<cac:DocumentReference>
	...
	<xsl:template match="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiOrdineAcquisto/CodiceCIG" mode="CIG_Riga">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<xsl:if test="../RiferimentoNumeroLinea[normalize-space()]=$CN/NumeroLinea[normalize-space()] or (../RiferimentoNumeroLinea and count(../../../DatiBeniServizi/DettaglioLinee)=1)">
			<cac:DocumentReference>
	...
	<xsl:template match="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiOrdineAcquisto/CodiceCUP" mode="CUP_Riga">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<xsl:if test="../RiferimentoNumeroLinea[normalize-space()]=$CN/NumeroLinea[normalize-space()] or (../RiferimentoNumeroLinea and count(../../../DatiBeniServizi/DettaglioLinee)=1)">
			<cac:DocumentReference>
	...
	<xsl:template match="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiRicezione/CodiceCIG" mode="CIG_Ricezione_Riga">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<xsl:if test="../RiferimentoNumeroLinea[normalize-space()]=$CN/NumeroLinea[normalize-space()]">
			<cac:DocumentReference>
	...
	<xsl:template match="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiRicezione/CodiceCUP" mode="CUP_Ricezione_Riga">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<xsl:if test="../RiferimentoNumeroLinea[normalize-space()]=$CN/NumeroLinea[normalize-space()]">
			<cac:DocumentReference>
	...
	<xsl:template match="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiRicezione/CodiceCommessaConvenzione" mode="CodiceCommessaConvenzione_Ricezione_Riga">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<xsl:if test="../RiferimentoNumeroLinea[normalize-space()]=$CN/NumeroLinea[normalize-space()]">
			<cac:DocumentReference>
					...
					<cac:Shipment>
						...
						<xsl:if test="PesoLordo &gt; 0.00">
							<cbc:GrossWeightMeasure>
								<xsl:variable name="variable_d7e392a1051169">
								...
								<xsl:if test="string($variable_d7e392a1051169)">
									<xsl:attribute name="unitCode">
										<xsl:value-of select="string($variable_d7e392a1051169)"/>
									</xsl:attribute>
								</xsl:if>
						...
						<xsl:if test="PesoNetto &gt; 0.00">
							<cbc:NetWeightMeasure>
								<xsl:variable name="variable_d7e393a1051169">
									<xsl:value-of select="if (document($xclUnitOfMeasureCode)//Value[@ColumnRef='code']/SimpleValue[../../Value[@ColumnRef='xname']/SimpleValue=current()/UnitaMisuraPeso][1]) then document($xclUnitOfMeasureCode)//Value[@ColumnRef='code']/SimpleValue[../../Value[@ColumnRef='xname']/SimpleValue=current()/UnitaMisuraPeso][1] else 'KGM'"/>
								</xsl:variable>
								<xsl:if test="string($variable_d7e393a1051169)">
									<xsl:attribute name="unitCode">
										<xsl:value-of select="string($variable_d7e393a1051169)"/>
									</xsl:attribute>
								</xsl:if>
	...
	<xsl:template match="/in:FatturaElettronica/FatturaElettronicaHeader/DatiTrasmissione">
		...
		<cac:ServiceProviderParty>
			...
			<cac:Party>
				<cac:PartyTaxScheme>
					<cbc:CompanyID>
						<xsl:variable name="variable_d7e286a1051010">
						...
						<xsl:if test="string($variable_d7e286a1051010)">
							<xsl:attribute name="schemeID">
								<xsl:value-of select="string($variable_d7e286a1051010)"/>
							</xsl:attribute>
						</xsl:if>
	...
	<xsl:template match="AltriDatiGestionali[upper-case(TipoDato)!='NOTA' and TipoDato!='DatiDDT' and TipoDato!='Natura']" mode="AltriDatiGestionali_Item">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
	...
	<xsl:template match="CodiceArticolo" mode="CommodityCode">
		...
		<xsl:if test="contains(',CommodityCode,TARIC,', concat(',',CodiceTipo,','))">
			<cbc:CommodityCode>
				<xsl:variable name="variable_d7e571a1051745">
					<xsl:value-of select="CodiceTipo"/>
				</xsl:variable>
				<xsl:if test="string($variable_d7e571a1051745)">
					<xsl:attribute name="listID">
						<xsl:value-of select="string($variable_d7e571a1051745)"/>
					</xsl:attribute>
				</xsl:if>
	...
	<xsl:template match="CodiceArticolo" mode="ItemClassificationCode">
		...
		<xsl:if test="contains(',ItemClassificationCode,CPV,UNSPSC,eCl@ss,', concat(',',CodiceTipo,','))">
			<cbc:ItemClassificationCode>
				<xsl:variable name="variable_d7e572a1051745">
					<xsl:value-of select="CodiceTipo"/>
				</xsl:variable>
				<xsl:if test="string($variable_d7e572a1051745)">
					<xsl:attribute name="listID">
						<xsl:value-of select="string($variable_d7e572a1051745)"/>
					</xsl:attribute>
				</xsl:if>
				<xsl:value-of select="CodiceValore"/>
			</cbc:ItemClassificationCode>
	...
	<xsl:template match="CodiceArticolo[contains(',STANDARDITEMIDENTIFICATION,AIC,EMEA,PARAF,EAN,', concat(',',upper-case(CodiceTipo),','))][1]" mode="StandardItemID2">
		...
		<xsl:if test="count(../CodiceArticolo[upper-case(CodiceTipo)='AICFARMACO'])=0">
			<cac:StandardItemIdentification>
				<cbc:ID>
					<xsl:variable name="variable_d7e567a1051010">
						<xsl:value-of select="CodiceTipo"/>
					</xsl:variable>
					<xsl:if test="string($variable_d7e567a1051010)">
						<xsl:attribute name="schemeID">
							<xsl:value-of select="string($variable_d7e567a1051010)"/>
						</xsl:attribute>
					</xsl:if>
					<xsl:value-of select="CodiceValore"/>
				</cbc:ID>
	...
	<xsl:template match="CodiceArticolo[not(CodiceTipo) or upper-case(CodiceTipo) = 'SELLERITEMIDENTIFICATION'][1]" mode="SellersItemID">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
	...
	<xsl:template match="CodiceArticolo[not(CodiceTipo)][position() &gt; 1] | CodiceArticolo[CodiceTipo and CodiceTipo!='AICFARMACO' and CodiceTipo!='AIC']" mode="AdditionalID">
		...
		<xsl:if test="not(CodiceTipo) or not(contains(',STANDARDITEMIDENTIFICATION,SELLERITEMIDENTIFICATION,ITEMCLASSIFICATIONCODE,CPV,UNSPSC,ECL@SS,ECLASS,COMMODITYCODE,TARIC,', concat(',',upper-case(CodiceTipo),',')))">
			<cac:AdditionalItemIdentification>
				<cbc:ID>
					<xsl:variable name="variable_d7e569a1051010">
						<xsl:value-of select="CodiceTipo"/>
					</xsl:variable>
					<xsl:if test="string($variable_d7e569a1051010)">
						<xsl:attribute name="schemeID">
							<xsl:value-of select="string($variable_d7e569a1051010)"/>
						</xsl:attribute>
					</xsl:if>
					<xsl:value-of select="CodiceValore"/>
				</cbc:ID>
	...
	<xsl:template match="CodiceArticolo[upper-case(CodiceTipo)='AICFARMACO'][1]" mode="StandardItemID">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<cac:StandardItemIdentification>
			<cbc:ID>
				<xsl:variable name="variable_d7e565a1051010">
					<xsl:value-of select="CodiceTipo"/>
				</xsl:variable>
				<xsl:if test="string($variable_d7e565a1051010)">
					<xsl:attribute name="schemeID">
						<xsl:value-of select="string($variable_d7e565a1051010)"/>
					</xsl:attribute>
				</xsl:if>
				<xsl:value-of select="CodiceValore"/>
			</cbc:ID>
	...
	<xsl:template match="DatiAnagrafici/IdFiscaleIVA" mode="VAT_CedentePrestatore">
		...
		<xsl:param name="CNP" select="1"/>
		<cbc:CompanyID>
			<xsl:variable name="variable_d7e220a1051010">
			...
			<xsl:if test="string($variable_d7e220a1051010)">
				<xsl:attribute name="schemeID">
					<xsl:value-of select="string($variable_d7e220a1051010)"/>
				</xsl:attribute>
			</xsl:if>
	...
	<xsl:template match="DatiAnagrafici/IdFiscaleIVA" mode="VAT_CessionaroCommittente">
		...
		<cac:PartyTaxScheme>
			<cbc:CompanyID>
				<xsl:variable name="variable_d7e315a1051010">
					<xsl:value-of select="document($xclVATSchemes)//Value[@ColumnRef='VATSchemeID']/SimpleValue[../../Value[@ColumnRef='code']/SimpleValue=current()/upper-case(IdPaese)][1]"/>
				</xsl:variable>
				<xsl:if test="string($variable_d7e315a1051010)">
					<xsl:attribute name="schemeID">
						<xsl:value-of select="string($variable_d7e315a1051010)"/>
					</xsl:attribute>
				</xsl:if>
				<xsl:value-of select="concat(IdPaese, IdCodice)"/>
			</cbc:CompanyID>
	...
	<xsl:template match="DatiBeniServizi/DatiRiepilogo" mode="Estensione_SpeseAccessorie_Riepilogo_IVA">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
	...
	<xsl:template match="DatiBeniServizi/DatiRiepilogo[EsigibilitaIVA!='S'][1]/EsigibilitaIVA" mode="AltreEsigibilita">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<xsl:if test="count(/*/FatturaElettronicaBody/DatiBeniServizi/DatiRiepilogo[EsigibilitaIVA='S']) = 0">
			<ext:UBLExtension>
				<ext:ExtensionURI>
	...
	<xsl:template match="DatiBeniServizi/DatiRiepilogo[EsigibilitaIVA='S'][1]/EsigibilitaIVA" mode="PrioritaAllaScissione">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<ext:UBLExtension>
			<ext:ExtensionURI>
	...
	<xsl:template match="DatiGenerali/DatiGeneraliDocumento/DatiBollo">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<xsl:if test=".">
			<ext:UBLExtension>
				...
				<ext:ExtensionContent>
					<cbc:TaxAmount currencyID="EUR">
						<xsl:value-of select="if(ImportoBollo) then ImportoBollo else 0.00"/>
		...
		<xsl:if test=".">
			<ext:UBLExtension>
				...
				<ext:ExtensionContent>
					<cac:TaxTotal>
						<cbc:TaxAmount>
							<xsl:variable name="variable_d7e7a1050860">
								<xsl:value-of select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiGeneraliDocumento/Divisa"/>
							</xsl:variable>
							<xsl:if test="string($variable_d7e7a1050860)">
								<xsl:attribute name="currencyID">
									<xsl:value-of select="string($variable_d7e7a1050860)"/>
								</xsl:attribute>
							</xsl:if>
						...
						<cac:TaxSubtotal>
							<xsl:if test="ImponibileCassa">
								<cbc:TaxableAmount>
									<xsl:variable name="variable_d7e9a1050860">
										<xsl:value-of select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiGeneraliDocumento/Divisa"/>
									</xsl:variable>
									<xsl:if test="string($variable_d7e9a1050860)">
										<xsl:attribute name="currencyID">
											<xsl:value-of select="string($variable_d7e9a1050860)"/>
										</xsl:attribute>
									</xsl:if>
							...
							<cbc:TaxAmount>
								<xsl:variable name="variable_d7e10a1050860">
									<xsl:value-of select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiGeneraliDocumento/Divisa"/>
								</xsl:variable>
								<xsl:if test="string($variable_d7e10a1050860)">
									<xsl:attribute name="currencyID">
										<xsl:value-of select="string($variable_d7e10a1050860)"/>
									</xsl:attribute>
								</xsl:if>
								<xsl:value-of select="ImportoContributoCassa"/>
							</cbc:TaxAmount>
	...
	<xsl:template match="DatiGenerali/DatiGeneraliDocumento/DatiRitenuta" mode="TipoRitenuta">
		...
		<xsl:if test="TipoRitenuta">
			<ext:UBLExtension>
				<ext:ExtensionURI>
					<xsl:value-of select="concat('urn:www.ubl-italia.org:spec:fatturapa:xref:tipo_ritenuta::', position())"/>
				</ext:ExtensionURI>
				<ext:ExtensionContent>
					<cr:XCode>
	...
	<xsl:template match="DatiGenerali/DatiGeneraliDocumento/TipoDocumento">
		...
		<ext:UBLExtension>
			<ext:ExtensionURI>
				<xsl:text>urn:www.ubl-italia.org:spec:fatturapa:xref:tipo_documento</xsl:text>
			</ext:ExtensionURI>
			<ext:ExtensionContent>
				<cr:XCode>
					<xsl:value-of select="."/>
	...
	<xsl:template match="FatturaElettronicaBody">
		...
		<ext:UBLExtensions>
			...
			<xsl:apply-templates select="DatiGenerali/DatiGeneraliDocumento/DatiBollo">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			...
			<xsl:apply-templates select="DatiBeniServizi/DatiRiepilogo[EsigibilitaIVA='S'][1]/EsigibilitaIVA" mode="PrioritaAllaScissione">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="DatiBeniServizi/DatiRiepilogo[EsigibilitaIVA!='S'][1]/EsigibilitaIVA" mode="AltreEsigibilita">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			...
			<xsl:apply-templates select="DatiBeniServizi/DatiRiepilogo" mode="Estensione_SpeseAccessorie_Riepilogo_IVA">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			...
			<cac:AdditionalDocumentReference>
				...
				<cac:Attachment>
					<cbc:EmbeddedDocumentBinaryObject>
						<xsl:variable name="variable_d7e193a1052308">
						...
						<xsl:if test="string($variable_d7e193a1052308)">
							<xsl:attribute name="mimeCode">
								<xsl:value-of select="string($variable_d7e193a1052308)"/>
							</xsl:attribute>
						</xsl:if>
	...
	<xsl:template match="FatturaElettronicaBody/DatiBeniServizi/DatiRiepilogo">
		...
		<cac:TaxSubtotal>
			<cbc:TaxableAmount>
				<xsl:variable name="variable_d7e427a1050860">
					<xsl:value-of select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiGeneraliDocumento/Divisa"/>
				</xsl:variable>
				<xsl:if test="string($variable_d7e427a1050860)">
					<xsl:attribute name="currencyID">
						<xsl:value-of select="string($variable_d7e427a1050860)"/>
					</xsl:attribute>
				</xsl:if>
				<xsl:value-of select="ImponibileImporto"/>
			</cbc:TaxableAmount>
			<cbc:TaxAmount>
				<xsl:variable name="variable_d7e428a1050860">
					<xsl:value-of select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiGeneraliDocumento/Divisa"/>
				</xsl:variable>
				<xsl:if test="string($variable_d7e428a1050860)">
					<xsl:attribute name="currencyID">
						<xsl:value-of select="string($variable_d7e428a1050860)"/>
					</xsl:attribute>
				</xsl:if>
	...
	<xsl:template match="FatturaElettronicaBody/DatiBeniServizi/DettaglioLinee">
		...
		<cac:InvoiceLine>
			<cbc:ID>
				<xsl:variable name="variable_d7e453a1051010">
					<xsl:value-of select="TipoCessionePrestazione"/>
				</xsl:variable>
				<xsl:if test="string($variable_d7e453a1051010)">
					<xsl:attribute name="schemeID">
						<xsl:value-of select="string($variable_d7e453a1051010)"/>
					</xsl:attribute>
				</xsl:if>
			...
			<cbc:InvoicedQuantity unitCodeListID="UNECERec20">
				<xsl:variable name="variable_d7e455a1051169">
				...
				<xsl:if test="string($variable_d7e455a1051169)">
					<xsl:attribute name="unitCode">
						<xsl:value-of select="string($variable_d7e455a1051169)"/>
					</xsl:attribute>
				</xsl:if>
				<xsl:value-of select="if (Quantita) then Quantita else 1.00"/>
			</cbc:InvoicedQuantity>
			<cbc:LineExtensionAmount>
				<xsl:variable name="variable_d7e456a1050860">
					<xsl:value-of select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiGeneraliDocumento/Divisa"/>
				</xsl:variable>
				<xsl:if test="string($variable_d7e456a1050860)">
					<xsl:attribute name="currencyID">
						<xsl:value-of select="string($variable_d7e456a1050860)"/>
					</xsl:attribute>
				</xsl:if>
			...
			<xsl:apply-templates select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiFattureCollegate" mode="BillingLineReference">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			...
			<xsl:apply-templates select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiRicezione/CodiceCommessaConvenzione" mode="CodiceCommessaConvenzione_Ricezione_Riga">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiFattureCollegate/CodiceCommessaConvenzione" mode="CodiceCommessaConvenzione_FattureCollegate_Riga">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiOrdineAcquisto/CodiceCUP" mode="CUP_Riga">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			...
			<xsl:apply-templates select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiConvenzione/CodiceCUP" mode="CUP_Convenzione_Riga">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiRicezione/CodiceCUP" mode="CUP_Ricezione_Riga">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiFattureCollegate/CodiceCUP" mode="CUP_FattureCollegate_Riga">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiOrdineAcquisto/CodiceCIG" mode="CIG_Riga">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			...
			<xsl:apply-templates select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiConvenzione/CodiceCIG" mode="CIG_Convenzione_Riga">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiRicezione/CodiceCIG" mode="CIG_Ricezione_Riga">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiFattureCollegate/CodiceCIG" mode="CIG_FattureCollegate_Riga">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiConvenzione" mode="EstremiConvenzione_Riga">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiContratto" mode="EstremiContratto_Riga">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			...
			<cac:Item>
				...
				<xsl:apply-templates select="CodiceArticolo[not(CodiceTipo) or upper-case(CodiceTipo) = 'SELLERITEMIDENTIFICATION'][1]" mode="SellersItemID">
					<xsl:with-param name="CN" select="current()"/>
					<xsl:with-param name="CNP" select="position()"/>
				</xsl:apply-templates>
				<xsl:apply-templates select="CodiceArticolo[upper-case(CodiceTipo)='AICFARMACO'][1]" mode="StandardItemID">
					<xsl:with-param name="CN" select="current()"/>
					<xsl:with-param name="CNP" select="position()"/>
				</xsl:apply-templates>
				...
				<xsl:apply-templates select="AltriDatiGestionali[upper-case(TipoDato)!='NOTA' and TipoDato!='DatiDDT' and TipoDato!='Natura']" mode="AltriDatiGestionali_Item">
					<xsl:with-param name="CN" select="current()"/>
					<xsl:with-param name="CNP" select="position()"/>
				</xsl:apply-templates>
			</cac:Item>
			<cac:Price>
				<cbc:PriceAmount>
					<xsl:variable name="variable_d7e584a1050860">
						<xsl:value-of select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiGeneraliDocumento/Divisa"/>
					</xsl:variable>
					<xsl:if test="string($variable_d7e584a1050860)">
						<xsl:attribute name="currencyID">
							<xsl:value-of select="string($variable_d7e584a1050860)"/>
						</xsl:attribute>
					</xsl:if>
	...
	<xsl:template match="FatturaElettronicaBody/DatiGenerali/DatiContratto[not(RiferimentoNumeroLinea)]/CodiceCIG" mode="CIG_CONTRATTO">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<cac:AdditionalDocumentReference>
			<cbc:ID>
	...
	<xsl:template match="FatturaElettronicaBody/DatiGenerali/DatiContratto[not(RiferimentoNumeroLinea)]/CodiceCUP" mode="CUP_CONTRATTO">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<cac:AdditionalDocumentReference>
			<cbc:ID>
	...
	<xsl:template match="FatturaElettronicaBody/DatiGenerali/DatiContratto[not(RiferimentoNumeroLinea)]/CodiceCommessaConvenzione" mode="CodiceCommessaConvenzione_CONTRATTO">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<cac:AdditionalDocumentReference>
			<cbc:ID>
	...
	<xsl:template match="FatturaElettronicaBody/DatiGenerali/DatiConvenzione[not(RiferimentoNumeroLinea)]/CodiceCIG" mode="CIG_Convenzione">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<cac:AdditionalDocumentReference>
			<cbc:ID>
	...
	<xsl:template match="FatturaElettronicaBody/DatiGenerali/DatiConvenzione[not(RiferimentoNumeroLinea)]/CodiceCUP" mode="CUP_CONVENZIONE">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<cac:AdditionalDocumentReference>
			<cbc:ID>
	...
	<xsl:template match="FatturaElettronicaBody/DatiGenerali/DatiConvenzione[not(RiferimentoNumeroLinea)]/CodiceCommessaConvenzione" mode="CodiceCommessaConvenzione_CONVENZIONE">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<cac:AdditionalDocumentReference>
			<cbc:ID>
	...
	<xsl:template match="FatturaElettronicaBody/DatiGenerali/DatiDDT" mode="DespatchDocumentReference">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<xsl:if test="not(RiferimentoNumeroLinea)">
	...
	<xsl:template match="FatturaElettronicaBody/DatiGenerali/DatiFattureCollegate" mode="BillingReference">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<xsl:if test="not(RiferimentoNumeroLinea)">
			<cac:BillingReference>
	...
	<xsl:template match="FatturaElettronicaBody/DatiGenerali/DatiFattureCollegate[not(RiferimentoNumeroLinea)]/CodiceCIG" mode="CIG_FattureCollegate">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<cac:AdditionalDocumentReference>
			<cbc:ID>
	...
	<xsl:template match="FatturaElettronicaBody/DatiGenerali/DatiFattureCollegate[not(RiferimentoNumeroLinea)]/CodiceCUP" mode="CUP_FATTURE_COLLEGATE">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<cac:AdditionalDocumentReference>
			<cbc:ID>
	...
	<xsl:template match="FatturaElettronicaBody/DatiGenerali/DatiFattureCollegate[not(RiferimentoNumeroLinea)]/CodiceCommessaConvenzione" mode="CodiceCommessaConvenzione_FATTURE_COLLEGATE">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<cac:AdditionalDocumentReference>
			<cbc:ID>
		...
		<cac:LegalMonetaryTotal>
			<xsl:if test="ImportoTotaleDocumento">
				<cbc:TaxInclusiveAmount>
					<xsl:variable name="variable_d7e449a1050860">
						<xsl:value-of select="Divisa"/>
					</xsl:variable>
					<xsl:if test="string($variable_d7e449a1050860)">
						<xsl:attribute name="currencyID">
							<xsl:value-of select="string($variable_d7e449a1050860)"/>
						</xsl:attribute>
					</xsl:if>
			...
			<xsl:if test="Arrotondamento &gt; 0.00">
				<cbc:PayableRoundingAmount>
					<xsl:variable name="variable_d7e450a1050860">
						<xsl:value-of select="Divisa"/>
					</xsl:variable>
					<xsl:if test="string($variable_d7e450a1050860)">
						<xsl:attribute name="currencyID">
							<xsl:value-of select="string($variable_d7e450a1050860)"/>
						</xsl:attribute>
					</xsl:if>
					<xsl:value-of select="Arrotondamento"/>
				</cbc:PayableRoundingAmount>
			...
			<cbc:PayableAmount>
				<xsl:variable name="variable_d7e451a1050860">
					<xsl:value-of select="Divisa"/>
				</xsl:variable>
				<xsl:if test="string($variable_d7e451a1050860)">
					<xsl:attribute name="currencyID">
						<xsl:value-of select="string($variable_d7e451a1050860)"/>
					</xsl:attribute>
				</xsl:if>
	...
	<xsl:template match="FatturaElettronicaBody/DatiGenerali/DatiGeneraliDocumento/DatiRitenuta">
		...
		<cac:WithholdingTaxTotal>
			<cbc:TaxAmount>
				<xsl:variable name="variable_d7e437a1050860">
					<xsl:value-of select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiGeneraliDocumento/Divisa"/>
				</xsl:variable>
				<xsl:if test="string($variable_d7e437a1050860)">
					<xsl:attribute name="currencyID">
						<xsl:value-of select="string($variable_d7e437a1050860)"/>
					</xsl:attribute>
				</xsl:if>
			...
			<cac:TaxSubtotal>
				<cbc:TaxAmount>
					<xsl:variable name="variable_d7e439a1050860">
						<xsl:value-of select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiGeneraliDocumento/Divisa"/>
					</xsl:variable>
					<xsl:if test="string($variable_d7e439a1050860)">
						<xsl:attribute name="currencyID">
							<xsl:value-of select="string($variable_d7e439a1050860)"/>
						</xsl:attribute>
					</xsl:if>
					<xsl:value-of select="ImportoRitenuta"/>
				</cbc:TaxAmount>
	...
	<xsl:template match="FatturaElettronicaBody/DatiGenerali/DatiGeneraliDocumento/ScontoMaggiorazione">
		...
		<xsl:if test="Importo">
			<cac:AllowanceCharge>
				...
				<cbc:Amount>
					<xsl:variable name="variable_d7e423a1050860">
						<xsl:value-of select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiGeneraliDocumento/Divisa"/>
					</xsl:variable>
					<xsl:if test="string($variable_d7e423a1050860)">
						<xsl:attribute name="currencyID">
							<xsl:value-of select="string($variable_d7e423a1050860)"/>
						</xsl:attribute>
					</xsl:if>
	...
	<xsl:template match="FatturaElettronicaBody/DatiGenerali" mode="OrderReference">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<xsl:for-each select="./DatiOrdineAcquisto[(not(./RiferimentoNumeroLinea)) or not(./RiferimentoNumeroLinea=/in:FatturaElettronica/FatturaElettronicaBody/DatiBeniServizi/DettaglioLinee/NumeroLinea)]">
			<xsl:choose>
	...
	<xsl:template match="FatturaElettronicaBody/DatiGenerali/DatiOrdineAcquisto/CodiceCIG" mode="CIG">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<xsl:variable name="riferimento" select="../RiferimentoNumeroLinea"/>
		<xsl:if test="(../IdDocumento and not(../RiferimentoNumeroLinea)) or not (/in:FatturaElettronica/FatturaElettronicaBody/DatiBeniServizi/DettaglioLinee[NumeroLinea = $riferimento])">
			<cac:AdditionalDocumentReference>
				<cbc:ID>
					<xsl:value-of select="."/>
				</cbc:ID>
	...
	<xsl:template match="FatturaElettronicaBody/DatiGenerali/DatiOrdineAcquisto/CodiceCUP" mode="CUP">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<xsl:variable name="riferimento" select="../RiferimentoNumeroLinea"/>
		<xsl:if test="(../IdDocumento and not(../RiferimentoNumeroLinea)) or not (/in:FatturaElettronica/FatturaElettronicaBody/DatiBeniServizi/DettaglioLinee[NumeroLinea = $riferimento])">
	...
	<xsl:template match="FatturaElettronicaBody/DatiGenerali/DatiOrdineAcquisto/CodiceCommessaConvenzione" mode="CodiceCommessaConvenzione">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<xsl:variable name="riferimento" select="../RiferimentoNumeroLinea"/>
		<xsl:if test="(../IdDocumento and not(../RiferimentoNumeroLinea)) or not (/in:FatturaElettronica/FatturaElettronicaBody/DatiBeniServizi/DettaglioLinee[NumeroLinea = $riferimento])">
	...
	<xsl:template match="FatturaElettronicaBody/DatiGenerali" mode="AdditionalOrders">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<xsl:for-each select="./DatiOrdineAcquisto[(not(./RiferimentoNumeroLinea)) or not(./RiferimentoNumeroLinea=/in:FatturaElettronica/FatturaElettronicaBody/DatiBeniServizi/DettaglioLinee/NumeroLinea)]">
			<xsl:choose>
	...
	<xsl:template match="FatturaElettronicaBody/DatiGenerali/DatiRicezione[not(RiferimentoNumeroLinea)]/CodiceCIG" mode="CIG_Ricezione">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<cac:AdditionalDocumentReference>
			<cbc:ID>
	...
	<xsl:template match="FatturaElettronicaBody/DatiGenerali/DatiRicezione[not(RiferimentoNumeroLinea)]/CodiceCUP" mode="CUP_RICEZIONE">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<cac:AdditionalDocumentReference>
			<cbc:ID>
	...
	<xsl:template match="FatturaElettronicaBody/DatiGenerali/DatiRicezione[not(RiferimentoNumeroLinea)]/CodiceCommessaConvenzione" mode="CodiceCommessaConvenzione_RICEZIONE">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<cac:AdditionalDocumentReference>
			<cbc:ID>
	...
	<xsl:template match="FatturaElettronicaBody/DatiPagamento/DettaglioPagamento" mode="ModalitàPagamento">
		<xsl:param name="CN" select="."/>
		<xsl:param name="CNP" select="1"/>
		<cac:PaymentMeans>
			...
			<xsl:if test="IBAN or CAB or ABI or BIC or IstitutoFinanziario">
				<cac:PayeeFinancialAccount>
					<xsl:if test="IBAN">
						<cbc:ID>
							<xsl:variable name="variable_d7e402a1051010">
								<xsl:value-of select="if (IBAN) then 'IBAN' else 'LOCAL'"/>
							</xsl:variable>
							<xsl:if test="string($variable_d7e402a1051010)">
								<xsl:attribute name="schemeID">
									<xsl:value-of select="string($variable_d7e402a1051010)"/>
								</xsl:attribute>
							</xsl:if>
	...
	<xsl:template match="FatturaElettronicaBody/DatiPagamento[1]/DettaglioPagamento[1]" mode="TerminiPagamento">
		...
		<cac:PaymentTerms>
			<xsl:if test="ImportoPagamento">
				<cbc:Amount>
					<xsl:variable name="variable_d7e411a1050860">
						<xsl:value-of select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiGeneraliDocumento/Divisa"/>
					</xsl:variable>
					<xsl:if test="string($variable_d7e411a1050860)">
						<xsl:attribute name="currencyID">
							<xsl:value-of select="string($variable_d7e411a1050860)"/>
						</xsl:attribute>
					</xsl:if>
			...
			<xsl:if test="ScontoPagamentoAnticipato &gt; 0.00">
				<cbc:SettlementDiscountAmount>
					<xsl:variable name="variable_d7e412a1050860">
						<xsl:value-of select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiGeneraliDocumento/Divisa"/>
					</xsl:variable>
					<xsl:if test="string($variable_d7e412a1050860)">
						<xsl:attribute name="currencyID">
							<xsl:value-of select="string($variable_d7e412a1050860)"/>
						</xsl:attribute>
					</xsl:if>
			...
			<xsl:if test="PenalitaPagamentiRitardati &gt; 0.00">
				<cbc:PenaltyAmount>
					<xsl:variable name="variable_d7e413a1050860">
						<xsl:value-of select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiGeneraliDocumento/Divisa"/>
					</xsl:variable>
					<xsl:if test="string($variable_d7e413a1050860)">
						<xsl:attribute name="currencyID">
							<xsl:value-of select="string($variable_d7e413a1050860)"/>
						</xsl:attribute>
					</xsl:if>
	...
	<xsl:template match="FatturaElettronicaHeader/CedentePrestatore">
		...
		<cac:AccountingSupplierParty>
			...
			<cac:Party>
				...
				<xsl:apply-templates select="DatiAnagrafici/Anagrafica[Nome or Cognome]" mode="NomeCedentePrestatore2">
					<xsl:with-param name="CN" select="current()"/>
					<xsl:with-param name="CNP" select="position()"/>
				</xsl:apply-templates>
	...
	<xsl:template match="FatturaElettronicaHeader/CessionarioCommittente">
		...
		<cac:AccountingCustomerParty>
			<cac:Party>
				...
				<xsl:apply-templates select="DatiAnagrafici/Anagrafica/Denominazione" mode="NomeCessionarioCommittente1">
					<xsl:with-param name="CN" select="current()"/>
					<xsl:with-param name="CNP" select="position()"/>
				</xsl:apply-templates>
				<xsl:apply-templates select="DatiAnagrafici/Anagrafica[Nome or Cognome]" mode="NomeCessionarioCommittente2">
					<xsl:with-param name="CN" select="current()"/>
					<xsl:with-param name="CNP" select="position()"/>
				</xsl:apply-templates>
	...
	<xsl:template match="FatturaElettronicaHeader/RappresentanteFiscale">
		...
		<cac:TaxRepresentativeParty>
			<xsl:apply-templates select="DatiAnagrafici/Anagrafica/Denominazione" mode="NomeRappresentanteFiscale1">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="DatiAnagrafici/Anagrafica[Nome or Cognome]" mode="NomeRappresentanteFiscale2">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<cac:PartyTaxScheme>
	...
	<xsl:template match="IdFiscaleIVA" mode="VAT_SoggettoEmittente">
		...
		<xsl:param name="CNP" select="1"/>
		<cbc:CompanyID>
			<xsl:variable name="variable_d7e272a1051010">
				<xsl:value-of select="document($xclVATSchemes)//Value[@ColumnRef='VATSchemeID']/SimpleValue[../../Value[@ColumnRef='code']/SimpleValue=current()/upper-case(IdPaese)][1]"/>
			</xsl:variable>
			<xsl:if test="string($variable_d7e272a1051010)">
				<xsl:attribute name="schemeID">
					<xsl:value-of select="string($variable_d7e272a1051010)"/>
				</xsl:attribute>
			</xsl:if>
			<xsl:value-of select="concat(IdPaese, IdCodice)"/>
		</cbc:CompanyID>
	...
	<xsl:template match="IdFiscaleIVA">
		...
		<xsl:param name="CNP" select="1"/>
		<cbc:CompanyID>
			<xsl:variable name="variable_d7e376a1051010">
				<xsl:value-of select="document($xclVATSchemes)//Value[@ColumnRef='VATSchemeID']/SimpleValue[../../Value[@ColumnRef='code']/SimpleValue=current()/upper-case(IdPaese)][1]"/>
			</xsl:variable>
			<xsl:if test="string($variable_d7e376a1051010)">
				<xsl:attribute name="schemeID">
					<xsl:value-of select="string($variable_d7e376a1051010)"/>
				</xsl:attribute>
			</xsl:if>
			<xsl:value-of select="concat(IdPaese, IdCodice)"/>
		</cbc:CompanyID>
		...
		<cac:PartyLegalEntity>
			...
			<xsl:if test="CapitaleSociale">
				<cbc:CorporateStockAmount>
					<xsl:variable name="variable_d7e241a1050860">
						<xsl:value-of select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiGeneraliDocumento/Divisa"/>
					</xsl:variable>
					<xsl:if test="string($variable_d7e241a1050860)">
						<xsl:attribute name="currencyID">
							<xsl:value-of select="string($variable_d7e241a1050860)"/>
						</xsl:attribute>
					</xsl:if>
	...
	<xsl:template match="ScontoMaggiorazione" mode="ScontoMaggiorazioneRiga">
		...
		<xsl:if test="Importo">
			<cac:AllowanceCharge>
				...
				<cbc:Amount>
					<xsl:variable name="variable_d7e559a1050860">
						<xsl:value-of select="/in:FatturaElettronica/FatturaElettronicaBody/DatiGenerali/DatiGeneraliDocumento/Divisa"/>
					</xsl:variable>
					<xsl:if test="string($variable_d7e559a1050860)">
						<xsl:attribute name="currencyID">
							<xsl:value-of select="string($variable_d7e559a1050860)"/>
						</xsl:attribute>
					</xsl:if>
					<xsl:value-of select="Importo"/>
				</cbc:Amount>
	...
	<xsl:template match="/in:FatturaElettronica" name="root">
		...
		<Invoice>
			...
			<cbc:ID>
				<xsl:variable name="variable_d7e88a1051010">
					<xsl:value-of select="if (FatturaElettronicaBody/DatiGenerali/DatiGeneraliDocumento/Art73 = 'SI') then 'art73dpr633/72' else ''"/>
				</xsl:variable>
				<xsl:if test="string($variable_d7e88a1051010)">
					<xsl:attribute name="schemeID">
						<xsl:value-of select="string($variable_d7e88a1051010)"/>
					</xsl:attribute>
				</xsl:if>
			...
			<xsl:apply-templates select="FatturaElettronicaBody/DatiGenerali" mode="OrderReference">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="FatturaElettronicaBody/DatiGenerali/DatiFattureCollegate" mode="BillingReference">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			...
			<xsl:apply-templates select="FatturaElettronicaBody/DatiGenerali/DatiDDT" mode="DespatchDocumentReference">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			...
			<xsl:apply-templates select="FatturaElettronicaBody/DatiGenerali/DatiOrdineAcquisto/CodiceCommessaConvenzione" mode="CodiceCommessaConvenzione">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="FatturaElettronicaBody/DatiGenerali/DatiContratto[not(RiferimentoNumeroLinea)]/CodiceCommessaConvenzione" mode="CodiceCommessaConvenzione_CONTRATTO">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="FatturaElettronicaBody/DatiGenerali/DatiConvenzione[not(RiferimentoNumeroLinea)]/CodiceCommessaConvenzione" mode="CodiceCommessaConvenzione_CONVENZIONE">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="FatturaElettronicaBody/DatiGenerali/DatiRicezione[not(RiferimentoNumeroLinea)]/CodiceCommessaConvenzione" mode="CodiceCommessaConvenzione_RICEZIONE">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="FatturaElettronicaBody/DatiGenerali/DatiFattureCollegate[not(RiferimentoNumeroLinea)]/CodiceCommessaConvenzione" mode="CodiceCommessaConvenzione_FATTURE_COLLEGATE">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="FatturaElettronicaBody/DatiGenerali/DatiOrdineAcquisto/CodiceCUP" mode="CUP">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="FatturaElettronicaBody/DatiGenerali/DatiContratto[not(RiferimentoNumeroLinea)]/CodiceCUP" mode="CUP_CONTRATTO">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="FatturaElettronicaBody/DatiGenerali/DatiConvenzione[not(RiferimentoNumeroLinea)]/CodiceCUP" mode="CUP_CONVENZIONE">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="FatturaElettronicaBody/DatiGenerali/DatiRicezione[not(RiferimentoNumeroLinea)]/CodiceCUP" mode="CUP_RICEZIONE">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="FatturaElettronicaBody/DatiGenerali/DatiFattureCollegate[not(RiferimentoNumeroLinea)]/CodiceCUP" mode="CUP_FATTURE_COLLEGATE">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="FatturaElettronicaBody/DatiGenerali/DatiOrdineAcquisto/CodiceCIG" mode="CIG">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="FatturaElettronicaBody/DatiGenerali/DatiContratto[not(RiferimentoNumeroLinea)]/CodiceCIG" mode="CIG_CONTRATTO">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="FatturaElettronicaBody/DatiGenerali/DatiConvenzione[not(RiferimentoNumeroLinea)]/CodiceCIG" mode="CIG_Convenzione">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="FatturaElettronicaBody/DatiGenerali/DatiRicezione[not(RiferimentoNumeroLinea)]/CodiceCIG" mode="CIG_Ricezione">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			<xsl:apply-templates select="FatturaElettronicaBody/DatiGenerali/DatiFattureCollegate[not(RiferimentoNumeroLinea)]/CodiceCIG" mode="CIG_FattureCollegate">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			...
			<xsl:apply-templates select="FatturaElettronicaBody/DatiGenerali" mode="AdditionalOrders">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			...
			<xsl:apply-templates select="FatturaElettronicaBody/DatiPagamento/DettaglioPagamento" mode="ModalitàPagamento">
				<xsl:with-param name="CN" select="current()"/>
				<xsl:with-param name="CNP" select="position()"/>
			</xsl:apply-templates>
			...
			<cac:TaxTotal>
				<cbc:TaxAmount>
					<xsl:variable name="variable_d7e425a1050860">
						<xsl:value-of select="FatturaElettronicaBody/DatiGenerali/DatiGeneraliDocumento/Divisa"/>
					</xsl:variable>
					<xsl:if test="string($variable_d7e425a1050860)">
						<xsl:attribute name="currencyID">
							<xsl:value-of select="string($variable_d7e425a1050860)"/>
						</xsl:attribute>
					</xsl:if>
