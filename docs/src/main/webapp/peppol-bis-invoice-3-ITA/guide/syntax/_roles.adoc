...
#Nel caso in cui si voglia indicare anche il Codice Fiscale, quest’ultimo va indicato nel *cac:PartyLegalEntity/cbc:CompanyID*, omettendo l’attributo @schemeID ma includendo il prefisso "CF:" come nell’esempio di seguito.#
