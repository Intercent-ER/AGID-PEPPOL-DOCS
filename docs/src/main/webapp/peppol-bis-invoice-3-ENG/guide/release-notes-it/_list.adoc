link:pass:[${peppoldocs.root.url}/my_index_fatt-ENG.jsp][Link to main site of documentation]
...
| 3.0.21.1(IT)
a| 20/05/2026
a| _Update to specifications https://docs.peppol.eu/poacc/billing/3.0/upcoming/release-notes/[PEPPOL BIS 3.0.21 - May release 2026]_. +

Effective as of *Monday 17 August 2026*

[red]#Changes to documentation# +

* Added new optional Profile 02 – Billing with response, which enables a process in which an invoice response is required following receipt of the invoice. This profile requires separate registration in the SMP and uses the Invoice Response BIS document. The specifications for this document are available on the https://docs.peppol.eu/poacc/other/[OpenPeppol Other BIS] specifications portal.
...
** Removed: ANG, BGN
** Added: XCG
* Change from “warning” to “fatal” of the severity of rules PEPPOL-COMMON-R052 (Denmark) and PEPPOL-COMMON-R053 (Denmark).
* Introduction of the new rules PEPPOL-COMMON-R054 (Netherlands), PEPPOL-COMMON-R055 (Netherlands), PEPPOL-COMMON-R056-1 (Netherlands), PEPPOL-COMMON-R056-2 (Netherlands), PEPPOL-COMMON-R057 (Netherlands) with severity “warning”. The rules will be set to severity “fatal” in a subsequent release.
* Change from “warning” to “fatal” of the severity of rules DK-R-017 (Denmark) and DK-R-003 (Denmark).

[red]#EN 16931 schematrons updated# +

* Update of schematron EN 16931
* Removed rule BR-CO-25
* Update of rule PEPPOL-EN16931-R004
* Added 2 new temporary profiles for UBL Invoice and Credit Note in rule PEPPOL-EN16931-R007 (France)

| 3.0.20.1(IT)
a| 11/12/2025
a| _Update to specifications https://docs.peppol.eu/poacc/billing/3.0/2025-Q4/[PEPPOL BIS 3.0.20 - November release 2025] and other Italian modifications_. +

Effective as of *Monday 23 February 2026*
...
** Added: 0244 
*ISO 6523 ICD list 
** Added: 0241,0242,0243,0244 
* ISO 4217 Currency codes 
** Removed: STN 
** Added: CNH,STD 
* VATEX code list 
** Added: VATEX-EU-135-1 
* Introduction of the rules PEPPOL-COMMON-R052 (Denmark) and PEPPOL-COMMON-R053 (Denmark) with level of severity “warning” for invoices from Danish suppliers.  
* Update of the text of the rule DK-R-010 (Denmark); 
* Introduction of the rule DK-R-017 (Denmark) with level of severity “warning” for invoices from Danish suppliers towards Danish clients.   
