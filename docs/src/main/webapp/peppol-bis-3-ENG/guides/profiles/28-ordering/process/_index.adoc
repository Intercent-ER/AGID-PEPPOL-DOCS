...
* the Order has been received (Risposta di ricezione);
* the Order is accepted without amendment (Risposta di accettazione);
* the Order is rejected (Risposta di diniego);
* the Order is accepted with amendment (Risposta con modifiche).
