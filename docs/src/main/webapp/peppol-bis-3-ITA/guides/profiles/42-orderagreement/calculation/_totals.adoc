[[totals]]
= Calcolo dei totali (LegalMonetaryTotals)
...
<cac:LegallMonetaryTotal>
    ...
    <cbc:PayableRoundingAmount currencyID="EUR">0.37</cbc:PayableRoundingAmount>   <cbc:PayableAmount currencyID="EUR">921.00</cbc:PayableAmount>
