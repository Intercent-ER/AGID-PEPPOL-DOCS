		...
		<%@include file="inc/header_other.jsp" %>
			...
			<div id="main" class="container" style="display: block;">
				...
				<dl class="dl-horizontal">
					<dd>
						<%@include file="../peppol-bis-3/menu/jumbo-list.html" %>
					</dd>
					<dt>Note di Rilascio</dt>
					<dd>
						<%@include file="../peppol-bis-3/menu/intro-list.html" %>
					</dd>
					<dt>Documentazione</dt>
					<dd>
						<%@include file="../peppol-bis-3/menu/bis-list.html" %>
					</dd>
					<dt>Sintassi</dt>
					<dd>
						<%@include file="../peppol-bis-3/menu/syntax-list.html" %>
					</dd>
					<dt>Regole</dt>
					<dd>
						<%@include file="../peppol-bis-3/menu/rule-list.html" %>
					</dd>
					<dt>Codifiche</dt>
					<dd>
						<%@include file="../peppol-bis-3/menu/codelist-list.html" %>
					</dd>
					<dt>Fogli di stile</dt>
					<dd>
						<%@include file="../peppol-bis-3/menu/stylesheet-list.html" %>
					</dd>
					<dt>Downloads</dt>
					<dd>
						<%@include file="../peppol-bis-3/menu/download-list.html" %>
					</dd>
				</dl>
			</div>
		</body>
