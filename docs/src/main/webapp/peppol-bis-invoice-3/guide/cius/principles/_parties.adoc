...
image::../../images/functionality-and-roles.png[Functionality and roles, align="center",width=100%, pdfwidth=100%, scaledwidth=100%]
...
Creditor::
One to whom a debt is owe. The party that claims the payment and is responsible for resolving b_illing issues and arranging settlement. The party that sends the invoice or credit note. Also known as invoice issuer, accounts receivable or seller.
