...
<pattern id="INT-UBL-T76" xmlns="http://purl.oclc.org/dsdl/schematron">
	...
	<!--rule context="/ubl:OrderResponse"> 
		<assert test="cbc:CustomizationID = 'urn:fdc:peppol.eu:poacc:trns:order_response:3:extended:urn:www.ubl-italia.org:spec:ordine:ver3.1' and cbc:ProfileID = 'urn:fdc:peppol.eu:poacc:bis:ordering:3'" flag="fatal" id="INT-T76-R003">[INT-T76-R003] - La versione della Risposta d'Ordine DEVE essere identificata dai seguenti identificativi: 
...
ProfileID = 'urn:fdc:peppol.eu:poacc:bis:ordering:3'.</assert>
	...
	<rule context="//cac:BuyerCustomerParty/cac:Party" flag="fatal"> 
		<assert test="cac:PartyIdentification/cbc:ID[@schemeID='9921'][string-length(translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789','')) = 0 and string-length() = 6] or cbc:EndpointID[@schemeID='9921']" flag="fatal" id="INT-T76-R007">INT-T76-R007 - Una risposta d'ordine DEVE contenere Il codice UFE IPA dell'ufficio della PA che ha emesso l'ordine, composto da 6 caratteri ASCII alfanumerici maiuscoli.</assert>
	</rule>
