...
P4:: [lime-background]#Pre pagamento#
P5:: [lime-background]#Pagamento immediato di un ordine senza contratto#
P6:: [lime-background]#Pagamento anticipato rispetto alla consegna#
