...
L’elemento ProfileID identifica il processo del quale il documento di business fa parte. Il PEPPOL BIS usa il sistema d’identificazione di BII; l’identificativo di processo seguente è utilizzato per il profilo ― BII03 – Order Only: +
