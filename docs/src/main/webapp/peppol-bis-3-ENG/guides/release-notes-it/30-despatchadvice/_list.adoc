...
** Removed: STN 
** Added: CNH,STD 
* Introduction of the rules PEPPOL-COMMON-R052 (Denmark) and PEPPOL-COMMON-R053 (Denmark) with level of severity “warning” for despatch advices from Danish suppliers 
