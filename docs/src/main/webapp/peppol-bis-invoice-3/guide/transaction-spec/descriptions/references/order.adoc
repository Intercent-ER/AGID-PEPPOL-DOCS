...
. #Nel *cac:OrderReference/cbc:ID*  (BT-13 Purchase order reference) riportare il solo identificativo dell’ordine, come nel seguente esempio:#
...
.. #se la fornitura non promana da alcun processo di ordinazione (elettronico o tradizionale), è sufficiente non compilare i campi sopra menzionati;#
...
. #Nelle righe di fattura utilizzando l'elemento cac:OrderLineReference con le seguenti modalità alternative:#

.. #Con riferimento implicito all’Ordine fornito a livello testata;#
...
.. #Con riferimento esplicito alla riga di un Ordine a livello di riga fattura;#
...
.. #Con riferimento esplicito ad un Ordine completo a livello di riga fattura.#
