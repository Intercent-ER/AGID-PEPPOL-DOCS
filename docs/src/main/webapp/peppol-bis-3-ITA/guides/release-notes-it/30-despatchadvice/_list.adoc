...
* Modifica del livello di severità delle Regole di business per il Documento di Trasporto Peppol da WARNING a FATAL,  come anticipato con la pubblicazione in data 21/06/2023 dell’_Aggiornamento della specifica italiana sul Documento di Trasporto in relazione alle disposizioni contenute nel DPR n. 472/1996_.
