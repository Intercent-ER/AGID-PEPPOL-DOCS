...
<pattern id="INT-UBL-T01" xmlns="http://purl.oclc.org/dsdl/schematron">
	...
	<rule context="//cbc:EndpointID" flag="fatal">
		<assert test="((@schemeID='9921' or @schemeID='0201') and matches(.,'^[A-Z0-9]{6,8}$')) or (@schemeID!='9921' and @schemeID!='0201')" flag="fatal" id="INT-T01-R026">[INT-T01-R026] - Se l'identificatore di endpoint si basa sullo schema di identificatori IT:IPA (ICD: 0201 ex 9921), questo dovrà seguire la sintassi [A-Z0-9]{6,8}.</assert>
