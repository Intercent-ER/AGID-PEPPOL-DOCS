...
Il *cac:AdditionalItemProperty/cbc:Name* può essere valorizzato con "DatiVeicoli" (vedi par. 11.17),"Ritenuta" (vedi par. 5.7), "TipoCessionePrestazione" (vedi par. 11.9.3), "Natura" (vedi par.8.3) oppure come segue:
