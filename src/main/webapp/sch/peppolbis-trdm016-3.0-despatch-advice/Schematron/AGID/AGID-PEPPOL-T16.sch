...
<pattern id="INT-UBL-T16" xmlns="http://purl.oclc.org/dsdl/schematron">
	...
	<rule context="/ubl:DespatchAdvice" flag="fatal"> 
		<assert test="cbc:CustomizationID = 'urn:fdc:peppol.eu:poacc:trns:despatch_advice:3:extended:urn:www.agid.gov.it:trns:ddt:3.0' and cbc:ProfileID = 'urn:fdc:peppol.eu:poacc:bis:despatch_advice:3'" flag="fatal" id="INT-T16-R004">[INT-T16-R004] - La versione del DespatchAdvice (DDT) DEVE essere identificata dai seguenti identificativi: 
