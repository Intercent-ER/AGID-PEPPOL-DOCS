link:pass:[${peppoldocs.root.url}/my_index-ENG.jsp][Link to main site of documentation]
...
| 3.3.0.9(IT)
a| 20/05/2026
a| _Update to specifications https://docs.peppol.eu/poacc/upgrade-3/upcoming/release-notes/[PEPPOL BIS 3.0.17 - May release 2026]_. +
...
* Order:
** Added the new structure cac:QuotationLineReference containing the element cbc:LineID within the structure cac:OrderLine to indicate the reference to a specific line of the quotation document.
...
** Added: STN, XCG
* UNCL7161
** Added: CAX, CAY, CAZ, DAC, DAF, DAG, DAH, DAI, DAJ, DAK, DAL, DAM, DAN, DAO, DAP, DAQ, PRV
...
[red]#Schematron update# +

* Schematron update

| 3.0.0.8(IT)
a| 11/12/2025
a| _Update to specifications https://docs.peppol.eu/poacc/upgrade-3/2025-Q4/[PEPPOL BIS 3.0.16 - November release 2025]_. +
...
** Removed: STN 
** Added: CNH,STD 
* Introduction of the rules PEPPOL-COMMON-R052 (Denmark) and PEPPOL-COMMON-R053 (Denmark) with level of severity “warning” for orders sent to Danish suppliers 
* Introduction of rule PEPPOL-COMMON-R042 (Denmark) with level of severity “fatal”.
* Removal of rule PEPPOL-COMMON-R048 (Italy)
...
* Changed the severity level from WARNING to FATAL of the rules PEPPOL-T76-R007, PEPPOL-T76-R008 e PEPPOL-T76-R009;
* Electronic Address Scheme (EAS)
** Removed: 9901
