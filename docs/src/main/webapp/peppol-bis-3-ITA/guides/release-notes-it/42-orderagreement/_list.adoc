...
** Rimossi: STN 
** Aggiunti: CNH,STD 
* Introduzione delle regole PEPPOL-COMMON-R052 (Danimarca) e PEPPOL-COMMON-R053 (Danimarca) con severità “warning” valide per ordini pre-concordati inviati da fornitori danesi. 
