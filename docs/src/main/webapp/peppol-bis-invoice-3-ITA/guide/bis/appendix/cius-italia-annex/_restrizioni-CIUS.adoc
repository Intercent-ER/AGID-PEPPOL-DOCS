...
|
|Se il valore dell’elemento BT-40 (Seller country code) è diverso da "IT", il BT-24 deve essere valorizzato come segue: urn:cen.eu:en16931:2017#compliant#urn:fat turapa.gov.it:CIUS-IT:2.0.0
...
|BT-118 VAT category code BT-95 Document level allowence VAT category code BT-102 Document level charge VAT category code BT-151 invoiced item  VAT category code
|
