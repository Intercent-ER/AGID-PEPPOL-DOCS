...
:link-transaction: https://test-vefa.difi.no/peppolbis/poacc/b_illing/3.0/transaction-spec/[PEPPOL Invoice transaction specification]
:eas: link:/poacc/b_illing/3.0/codelist/eas/[Code list for electronic address]
