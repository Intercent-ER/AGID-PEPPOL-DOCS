...
#Il Codice Fiscale può essere espresso all'interno del Party nell'elemento PartyIdentification/ID omettendo l'attributo @schemeID ma includendo il prefisso "CF:" come nell'esempio di seguito.#
...
[source, xml, indent=0]
----
include::{snippet-dir}/agid-extensions.xml[tag=rappresentante_fiscale_cliente]
----
