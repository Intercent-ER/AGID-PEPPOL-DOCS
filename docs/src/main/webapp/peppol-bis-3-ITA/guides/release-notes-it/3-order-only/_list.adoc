...
** Rimossi: STN 
** Aggiunti: CNH,STD 
* Introduzione delle regole PEPPOL-COMMON-R052 (Danimarca) e PEPPOL-COMMON-R053 (Danimarca) con severità “warning” valide per ordini inviati verso fornitori danesi. 
...
* Modificato il paragrafo “6.4.2. Dettaglio sui Dispositivi Medici e loro identificazione - Codice UDI”; 
* Modificato paragrafo “6.16.1. Luogo di consegna (DeliveryLocation)”. 
...
** Aggiunti: PPI 
* Modificata da “warning” a “fatal” la severità della regola NSO_066 per la verifica della presenza di almeno un identificativo tra Codice Fiscale e Partita IVA del Cliente nell’Ordine.
