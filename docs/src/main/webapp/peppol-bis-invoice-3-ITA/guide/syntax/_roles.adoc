...
#La Partita IVA va indicata nel *cac:PartyTaxScheme/cbc:CompanyID*.#

#Il Codice Fiscale va indicato nel *cac:PartyLegalEntity/cbc:CompanyID*, valorizzando l’attributo @schemeID con “0210”.#
...
#Infine, il campo *cac:PartyIdentification/cbc:ID* può essere usato per indicare anche le informazioni relative a FPA 1.2.4.1 Ufficio e FPA 1.2.4.2 Numero REA  concatenando i due dati con il "&#x0023;", preceduti dalla stringa "REA:".#
