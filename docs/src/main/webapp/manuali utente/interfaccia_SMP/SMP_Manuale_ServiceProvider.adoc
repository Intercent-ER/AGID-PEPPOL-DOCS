...
[blue]#Autore: AgID# +
[blue]#Versione: 1.0.0# +
[blue]#Ultimo aggiornamento: 20/10/2022#
====
...
.Gestione password
image::images\SMP_Manuale_ServiceProvider-abc23.png[align=center]
...
image::images\SMP_Manuale_ServiceProvider-5487d.png[align=center]
...
image::images\SMP_Manuale_ServiceProvider-4d5a0.png[align=center]
...
image::images\SMP_Manuale_ServiceProvider-a4b61.png[align=center]
...
image::images\SMP_Manuale_ServiceProvider-c53a4.png[align=center]
...
image::images\SMP_Manuale_ServiceProvider-660dc.png[align=center]
...
image::images\SMP_Manuale_ServiceProvider-21507.png[align=center]

Il risultato della ricerca viene visualizzato nella sezione inferiore della maschera "Ricerca Participant Id Peppol",
...
image::images\SMP_Manuale_ServiceProvider-34247.png[align=center]
...
Inoltre, per ogni participant Id è possibile espandere la sezione tramite il tasto "freccia giù" posto al limite destro della riga (figura 11). +
...
image::images\SMP_Manuale_ServiceProvider-841b5.png[align=center]
...
.Tasto "Elimina Participant Id Peppol" da lista
image::images\SMP_Manuale_ServiceProvider-300bd.png[align=center]

A seguito della pressione dell’icona "trash", il sistema mostrerà all’utente un avviso (Figura 13) dove sarà indicato che, confermando l’operazione,
sarà cancellata la registrazione del Participant Id Peppol su SMP.

.Notifica di eliminazione
image::images\SMP_Manuale_ServiceProvider-f6ce6.png[align=center]
...
.Tasto "Modifica Participant Id Peppol" da lista
image::images\SMP_Manuale_ServiceProvider-423aa.png[align=center]
...
image::images\SMP_Manuale_ServiceProvider-2dc0a.png[align=center]
...
image::images\SMP_Manuale_ServiceProvider-c51e4.png[align=center]
...
.Flag obbligatori
image::images\SMP_Manuale_ServiceProvider-7c3f6.png[align=center]
...
Dopo l’inserimento della prima registrazione documento verrà attivato nella sezione inferiore della pagina il tasto “Aggiungi documento”. +
...
image::images\SMP_Manuale_ServiceProvider-7b8b7.png[align=center]
...
image::images\SMP_Manuale_ServiceProvider-e4669.png[align=center]
.Modifica Participant Id Peppol
image::images\SMP_Manuale_ServiceProvider-20ad1.png[align=center]
...
image::images\SMP_Manuale_ServiceProvider-edb32.png[align=center]
...
image::images\SMP_Manuale_ServiceProvider-7c3f7.png[align=center]

[CAUTION]
====
Qualora un participant Id Peppol abbia associata una sola registrazione a un tipo documento, agendo sl tasto "Elimina Documento" si procederà all'eliminazione della registrazione specifica e,
...
image::images\SMP_Manuale_ServiceProvider-dc123.png[align=center]
