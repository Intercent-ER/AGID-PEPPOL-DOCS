...
* Aggiunta della nuova sezione _4.11 Indicazione acconto in fattura di saldo _ contenente le modalità operative previste per l’indicazione di un acconto nella fattura di saldo; 
