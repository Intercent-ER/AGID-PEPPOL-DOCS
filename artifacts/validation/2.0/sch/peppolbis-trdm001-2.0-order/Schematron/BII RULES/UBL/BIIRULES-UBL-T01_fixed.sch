...
<!-- Fixes: BII2-T01-R003, BII2-T01-R006, BII2-T01-R007, BII2-T01-R009 -->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" is-a="T01" id="UBL-T01">
  ...
  <param name="BII2-T01-R003" value="count(distinct-values(cac:LineItem/cbc:ID))=count(cac:LineItem/cbc:ID)"/><!--(cac:LineItem/cbc:ID)-->
  <param name="BII2-T01-R004" value="(cbc:IssueDate)"/>
  <param name="BII2-T01-R005" value="(cac:ValidityPeriod/cbc:EndDate)"/>
  <param name="BII2-T01-R006" value="cbc:ID[normalize-space()]"/><!--(cbc:ID)-->
  <param name="BII2-T01-R007" value="cbc:AllowanceChargeReason[normalize-space()]"/><!--(cbc:AllowanceChargeReason)-->
  <param name="BII2-T01-R009" value="cbc:DocumentCurrencyCode[normalize-space()] and count(//@currencyID)=count(//*[@currencyID=/*/cbc:DocumentCurrencyCode])"/><!--(cbc:DocumentCurrencyCode)-->
