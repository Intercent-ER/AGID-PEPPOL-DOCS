...
3. #Nelle righe di fattura utilizzando l'elemento cac:OrderLineReference con le seguenti modalità alternative:#
+
a. #Con riferimento implicito all’Ordine fornito a livello testata;#
+
[source, xml, indent=0]
----
...
b. #Con riferimento esplicito alla riga di un Ordine a livello di riga fattura;#
+
[source, xml, indent=0]
----
<cac:OrderLineReference>
...
c. #Con riferimento esplicito ad un Ordine completo a livello di riga fattura.#
+
[source, xml, indent=0]
----
<cac:OrderLineReference>
