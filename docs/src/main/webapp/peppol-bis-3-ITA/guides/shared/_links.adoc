...
:description: La specifica Peppol per l'interoperabilità nel Business, d'ora in poi “BIS”, è stata sviluppata da OpenPeppolAISBL Post Award Coordinating Community ed è pubblicata come parte delle specifiche PEPPOL.
:author: OpenPeppolAISBL, Post-Award Coordinating Community
:version: 3.0.8
:ord_version_it: 3.3.0.9(IT)
:ddt_version_it: 3.1.0.8(IT)
:ord_agreement_version_it: 3.0.0.10(IT)
//PEPPOL
:peppol: https://peppol.org/[PEPPOL]
:common: https://peppol.org/[Peppol BIS common text and introduction]
:openpeppol: https://peppol.org/[OpenPEPPOL]
...
:RGS-NSO: http://www.rgs.mef.gov.it/VERSIONE-I/e_government/amministrazioni_pubbliche/acquisti_pubblici_in_rete_apir/nodo_di_smistamento_degli_ordini_di_acquisto_delle_amministrazioni_pubbliche_nso
...
:codelist-ICD: link:xml/ITA/peppol-bis-3/codelist/ICD.xml[Codifica ICD]
:codelist-EAS: link:xml/ITA/peppol-bis-3/codelist/eas.xml[Codifica EAS]
:vat-codes: link:xml/ITA/peppol-bis-3/codelist/UNCL5305.xml[Codifica UNCL5305]
:mime-codes: link:xml/ITA/peppol-bis-3/codelist/MimeCode.xml[Codifica Mime]
