| UBL-CR-001-NA *(warning)*
| A UBL invoice should not include extensions (not applied in the Italian context)
| UBL-CR-002 *(warning)*
...
| UBL-CR-018-NA *(warning)*
| A UBL invoice should not include the OrderReference IssueDate (not applied in the Italian context)
| UBL-CR-019 *(warning)*
...
| UBL-CR-047-NA *(warning)*
| A UBL invoice should not include the DespatchDocumentReference IssueDate (not applied in the Italian context)
| UBL-CR-048 *(warning)*
...
| UBL-CR-052-NA *(warning)*
| A UBL invoice should not include the DespatchDocumentReference LanguageID (not applied in the Italian context)
| UBL-CR-053 *(warning)*
...
| UBL-CR-170-NA *(warning)*
| A UBL invoice should not include the AccountingSupplierParty Party PartyTaxScheme TaxLevelCode (not applied in the Italian context)
| UBL-CR-171 *(warning)*
...
| UBL-CR-195-NA *(warning)*
| A UBL invoice should not include the AccountingSupplierParty Party ServiceProviderParty (not applied in the Italian context)
| UBL-CR-196 *(warning)*
...
| UBL-CR-513-NA *(warning)*
| A UBL invoice should not include the WithholdingTaxTotal (not applied in the Italian context)
| UBL-CR-514 *(warning)*
...
| UBL-CR-528-NA *(warning)*
| A UBL invoice should not include the InvoiceLine OrderLineReference OrderReference (not applied in the Italian context)
| UBL-CR-529-NA *(warning)*
| A UBL invoice should not include the InvoiceLine DespatchLineReference (not applied in the Italian context)
| UBL-CR-530 *(warning)*
...
| UBL-SR-52-NA *(warning)*
| Document reference shall occur maximum once (not applied in the Italian context)
