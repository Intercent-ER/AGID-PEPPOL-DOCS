...
La PEPPOL BIS è basata sul profilo *CEN WS/BII2 “Profile BII30 Dispatch Only”*, il quale è stato esteso in base ai requisiti di e-Procurement della Regione Emilia Romagna. +
