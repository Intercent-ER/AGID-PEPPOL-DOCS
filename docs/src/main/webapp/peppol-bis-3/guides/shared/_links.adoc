...
:peppol-b_illing: http://docs.peppol.eu/poacc/b_illing/3.0/[PEPPOL BIS B_illing 3.0]
...
:RGS-NSO: http://www.rgs.mef.gov.it/VERSIONE-I/e_government/amministrazioni_pubbliche/acquisti_pubblici_in_rete_apir/nodo_di_smistamento_degli_ordini_di_acquisto_delle_amministrazioni_pubbliche_nso/[RGS - NSO^, role="ext-link"]
...
:imr-UC: https://github.com/OpenPEPPOL/poacc-upgrade-3/tree/master/examples/use-case-examples/invoice-response[Use case example files]
