...
.Tabella di relazione tra Invoiced item VAT Category Code e Natura FPA
...
La gestione della natura è analoga a quanto previsto per la fatturazione domestica (vedi paragrafo 8.1.2).
...
[IMPORTANT]
#La sezione è utilizzata solo per la fatturazione domestica per Bollo (vedi paragrafo 5.9) e Rivalsa Cassa Previdenziale (vedi paragrafo 5.8).#
#Per gli sconti e maggiorazioni a livello di testata che non incidono sull’imponibile vedasi 11.5.Sconti e maggiorazioni.#
...
.Tabella di relazione tra VAT Category Code, VAT exemption reason code e Natura FPA
...
.Tabella di relazione tra natura FPA, VAT Category Code e VAT exemption reason code
...
La gestione della natura è analoga a quanto previsto per la fatturazione domestica (vedi paragrafo 8.3.2).
