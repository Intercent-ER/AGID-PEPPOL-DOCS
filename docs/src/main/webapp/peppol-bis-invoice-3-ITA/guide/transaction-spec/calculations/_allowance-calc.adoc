...
[IMPORTANT]
#Nel contesto nazionale lo sconto e la maggiorazione a livello di testato sono utilizzati solo per Bollo (vedi paragrafo 5.9) e Rivalsa Cassa Previdenziale (vedi paragrafo 5.8).#

#Tipico esempio di maggiorazione espressa con importo base e percentuale è la cassa previdenziale (vedi paragrafo 5.8).#

#Tipico esempio di sconto/maggiorazione con solo importo base è il bollo (vedi paragrafo 5.9).#
