...
* *0211* per le partite IVA (che sostirà il codice temporaneo 9906 a partire dal #XX/XX/XXXX#);

* *0210* per i Codici Fiscali di persona fisica o giuridica (che sostirà il codice temporaneo 9907 a partire dal #XX/XX/XXXX#);
