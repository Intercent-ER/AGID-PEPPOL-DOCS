...
Quando le righe del Documento di Trasporto sono relative a diversi ordini di acquisto, i riferimenti all'ordine devono essere indicati nelle a livello di riga. +
