...
[source, xml, indent=0]
----
    <cbc:cbc:CompanyLegalForm>100000.00#SU#LN</cbc:cbc:CompanyLegalForm>
----
...
<cac:Party>
	...
	<cac:PostalAddress>
		...
		<cac:PartyLegalEntity>
			<cbc:RegistrationName>NomeCognome:Mario#Rossi</cbc:RegistrationName>
...
#Il campo *cac:PartyName/cbc:Name* può essere usato per indicare il dato FPA 1.3.1.3.1 Denominazione preceduto dalla stringa "Denominazione:". In alternativa, lo stesso può essere usato per indicare i dati FPA 1.3.1.3.2 Nome e 1.3.1.3.3 Cognome preceduti dalla stringa "NomeCognome:" e concatenati dal simbolo "&#x0023;".#
