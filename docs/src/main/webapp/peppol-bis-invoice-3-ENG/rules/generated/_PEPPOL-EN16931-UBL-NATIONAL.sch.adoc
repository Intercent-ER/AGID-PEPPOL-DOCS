...
| 
.3+| GR-R-001-4 *(fatal)*
| 0 and string(number($IdSegments[3])) != 'NaN' and xs:integer($IdSegments[3]) >= 0" flag="fatal">When Supplier is Greek,
| /ubl-invoice:Invoice/cbc:ID[$isGreekSender] \| /ubl-creditnote:CreditNote/cbc:ID[$isGreekSender]
| 
.3+| GR-R-001-5 *(fatal)*
| 0 and (some $c in $greekDocumentType satisfies $IdSegments[4] = $c)" flag="fatal">When Supplier is Greek, the Invoice
| /ubl-invoice:Invoice/cbc:ID[$isGreekSender] \| /ubl-creditnote:CreditNote/cbc:ID[$isGreekSender]
| 
.3+| GR-R-001-6 *(fatal)*
| 0 " flag="fatal">When Supplier is Greek, the Invoice Id fifth segment must not be empty
| /ubl-invoice:Invoice/cbc:ID[$isGreekSender] \| /ubl-creditnote:CreditNote/cbc:ID[$isGreekSender]
| 
.3+| GR-R-001-7 *(fatal)*
| 0 " flag="fatal">When Supplier is Greek, the Invoice Id sixth segment must not be empty
| /ubl-invoice:Invoice/cbc:ID[$isGreekSender] \| /ubl-creditnote:CreditNote/cbc:ID[$isGreekSender]
| 
.3+| GR-R-002 *(fatal)*
| 0" flag="fatal">Greek Suppliers must provide their full name as they are registered in the Greek Business Registry
...
| matches(.,'^[1-9]([0-9]*)')
.3+| GR-R-005 *(fatal)*
| 0" flag="fatal">Greek Suppliers must provide the full name of the buyer
...
.3+| GR-R-008-3 *(fatal)*
| 0" flag="fatal">When Supplier is Greek and the INVOICE URL Document reference exists, the External Reference URI should
...
.3+| NL-R-008 *(fatal)*
| [NL-R-008] For suppliers in the Netherlands, the payment means code (cac:PaymentMeans/cbc:PaymentMeansCode) MUST be one
