...
* Regola PEPPOL-COMMON-R040: "GLN deve avere un formato valido secondo le regole GS1". Modificata la gravità da "warning" a "fatal". (La regola era stata introdotta nell'autunno del 2019 con gravità “warning” per evitare interruzioni, ma con l'intenzione di essere modificata a gravità "fatal" dopo 6-12 mesi);
