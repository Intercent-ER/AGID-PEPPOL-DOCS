...
[NOTE]
Gli Ordini di riscontro sostitutivi e gli Ordini di riscontro per diniego, rispettivamente, rimpiazzano e annullano l'Ordine Pre-concordato ivi indicato, sia tutte le altre Sostituzioni e Revoche, già trasmesse, riferite al relativo Ordine iniziale.
