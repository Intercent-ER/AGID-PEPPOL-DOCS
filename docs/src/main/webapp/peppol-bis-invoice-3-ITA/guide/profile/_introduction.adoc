...
[lime-background]#Le regole d’uso ed i paragrafi applicabili specificatamente delle alla fatturazione domestica verso i privati sono invece evidenziate in verde. La fatturazione verso i privati sottintende la messa a disposizione di un traduttore da UBL verso il formato FatturaPR che sarà reso disponibile successivamente.#
