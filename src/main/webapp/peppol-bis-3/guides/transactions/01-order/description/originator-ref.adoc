...
[yellow-background]#Nei casi di esclusione previsti dalle norme vigenti, in luogo del valore del CIG deve essere utilizzato uno dei codici presenti nella codelist *"Cause esclusione CIG (IT)"*, disponibile nella sezione CODIFICHE. Il motivo di esclusione va indicato inserendo l'apposito codice.#
