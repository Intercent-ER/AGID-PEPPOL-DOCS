...
| 1.2.0 | 06/02/2023 | Aggiornati capitoli 3 e 4 in relazione alle modalità di indicazione dell'indirizzo di contatto indicato per ricevere le informazioni sui certificati PKI.
|===
