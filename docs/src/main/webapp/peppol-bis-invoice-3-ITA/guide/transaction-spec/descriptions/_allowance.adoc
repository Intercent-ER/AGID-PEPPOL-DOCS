...
* Gli sconti (ChargeIndicator>false</cbc:ChargeIndicator) e le maggiorazioni (ChargeIndicator>true</cbc:ChargeIndicator) relativi al prezzo devono specificare l’importo (AllowanceCharge/Amount).
