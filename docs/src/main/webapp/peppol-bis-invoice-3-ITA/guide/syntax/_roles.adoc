...
<cac:AccountingSupplierParty>
 <cac:Party>
	...
	<cac:PartyLegalEntity>
		...
		<cbc:CompanyID schemeID="0201">01598570354</cbc:CompanyID>
	</cac:PartyLegalEntity>
	<cac:Contact>
...
= #Il Rappresentante fiscale del cliente (AccountingCustomerParty/PowerOfAttorney) - Estensione#
...
= #Stabile Organizzazione (AccountingSupplierParty/AgentParty) - Estensione#
...
= #Stabile Organizzazione (AccountingCustomerParty/AgentParty) - Estensione#
...
= #Il Terzo Intermediario o Soggetto Emittente (AccountingSupplierParty/ServiceProviderParty) - Estensione#
