...
Di seguito il link:pass:[${peppoldocs.root.url}/xml/ITA/peppol-bis-invoice-3/codelist/RegimeFiscale.html][link] alla codelist italiana contenente i codici del Regime Fiscale.
