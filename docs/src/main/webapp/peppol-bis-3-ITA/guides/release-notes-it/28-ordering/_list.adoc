...
** Rimossi: STN 
** Aggiunti: CNH,STD 
* Introduzione delle regole PEPPOL-COMMON-R052 (Danimarca) e PEPPOL-COMMON-R053 (Danimarca) con severità “warning” valide ordini inviati verso fornitori danesi. 
...
* Modificato il paragrafo “7.4.2. Dettaglio sui Dispositivi Medici e loro identificazione - Codice UDI”; 
...
* Modificato il livello di severità da WARNING a FATAL per le regole PEPPOL-T76-R007, PEPPOL-T76-R008 e PEPPOL-T76-R009;
* Electronic Address Scheme (EAS)
** Rimossi: 9901
