...
.6+|*220* .6+| Ordine di Acquisto | *-*  | Ordine di acquisto in senso stretto | *OF*  | Ordine di fatturazione per prodotti già in possesso del Cliente o già consumati
|*OFR*  | Ordine di fatturazione e reintegro |*ON*  | Ordine di noleggio | *OR*  | Ordine di regolazione | *OB*  | Ordine a budget 

.5+|*227* .5+| Ordine di consegna |*-*  | Ordinazione generica di consegna | *CD*  | Ordine in conto deposito
|*CV*  | Ordine in conto visione
| *CG*  | Ordine in comodato gratuito | *CN*  | Ordine in conto noleggio |

|===


*[red]#Ordine di acquisto (220)#*
