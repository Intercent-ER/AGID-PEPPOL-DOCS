...
----
<1> la Partita IVA del Vettore viene specificata con il prefisso PIVA: e senza l'attributo @schemeID in quanto la codifica ICD non include gli identificativi fiscali