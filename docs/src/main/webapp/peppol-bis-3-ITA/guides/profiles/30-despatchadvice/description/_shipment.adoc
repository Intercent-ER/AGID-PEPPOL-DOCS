...
[NOTE]
#Le misure come peso e volume sono obbligatoriamente espresse secondo unità di misura in base alla codifica link:../../../../../../xml/ITA/peppol-bis-3/codelist/UNECERec20-11e.html[UN/ECE Recommendation 20]. Le codifiche utilizzabili sono quelle correlate ad unità di misura italiane ed evidenziate in azzuro.#
...
<9> Tempi di evasione effettiva;
<10> Indirizzo di consegna, si rimanda al paragrafo 6.3.2 Luogo di consegna.
