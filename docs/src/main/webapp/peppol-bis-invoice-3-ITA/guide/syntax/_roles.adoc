...
[NOTE]
Trattasi di CIUS domestica (DC - Domestic CIUS)
...
[lime-background]#Nel contesto B2C il Cliente può essere un cittadino (una persona fisica).#
...
= [lime-background]#Stabile Organizzazione (AccountingCustomerParty/AgentParty) - Estensione#
