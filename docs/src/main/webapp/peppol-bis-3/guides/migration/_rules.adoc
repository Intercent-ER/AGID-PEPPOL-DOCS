...
The {migration-policy} affects all end‐users registered in a SMP for OpenPEPPOL bis specifications, other than invoice/b_illing, according to the following rules:
