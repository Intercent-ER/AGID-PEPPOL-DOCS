...
[IMPORTANT]
====
#Per la fatturazione verso soggetti italiani la sezione è utilizzata solo per Bollo (vedi paragrafo 5.9) e Rivalsa Cassa Previdenziale (vedi paragrafo 5.8).#
====
...
.#_Esempio UBL di sconto su prezzo_#
[source, xml, indent=0]
----
<cac:InvoiceLine>
    <!-- ... -->
