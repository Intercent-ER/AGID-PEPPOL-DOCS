...
La Peppol BIS è basata sul profilo *CEN WS/BII “BII Profile 03 Order Only”* e "localizzata" in base ai requisiti del modello italiano di e-Procurement, così come riportati nelle specifiche tecniche http://www.rgs.mef.gov.it/VERSIONE-I/e_government/amministrazioni_pubbliche/acquisti_pubblici_in_rete_apir/nodo_di_smistamento_degli_ordini_di_acquisto_delle_amministrazioni_pubbliche_nso/[NSO].
