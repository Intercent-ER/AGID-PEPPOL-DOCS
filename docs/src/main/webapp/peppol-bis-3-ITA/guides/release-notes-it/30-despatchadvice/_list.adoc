link:pass:[${peppoldocs.root.url}][Vai al Portale Specifiche]
...
| 3.1.0.8(IT)
a| 20/05/2026
a| _Aggiornamento alle specifiche https://docs.peppol.eu/poacc/upgrade-3/upcoming/release-notes/[PEPPOL BIS 3.0.17 - May release 2026]_. +
...
[red]#Aggiornamento schematron# +

* Aggiornamento schematron

| 3.1.0.7(IT)
a| 11/12/2025
a| _Aggiornamento alle specifiche https://docs.peppol.eu/poacc/upgrade-3/2025-Q4/[PEPPOL BIS 3.0.16 - November release 2025]_. +
...
** Rimossi: STN 
** Aggiunti: CNH,STD
* Introduzione delle regole PEPPOL-COMMON-R052 (Danimarca) e PEPPOL-COMMON-R053 (Danimarca) con severità “warning” valide per documenti di trasporto inviati da fornitori danesi. 
* Introduzione della regola PEPPOL-COMMON-R042 (Danimarca) con severità “fatal”.
* Rimozione della regola PEPPOL-COMMON-R048 (Italia)

| 3.1.0.6(IT)
a| 06/06/2025
a| _Aggiornamento alle specifiche https://docs.peppol.eu/poacc/upgrade-3/2025-Q2/release-notes/[PEPPOL BIS 3.0.15 - May release 2025] e altre modifiche italiane_. +

In vigore a partire dal *25 Agosto 2025*

[red]#Cambiamenti alla specifica (Documentazione)#

* Aggiunto nuovo paragrafo “3.2.1 Processo di reso della merce” che descrive il flusso nel caso di documento di trasporto di reso; 
* Aggiunto nuovo paragrafo “4.4 Tipologia di consegna” che descrive i diversi processi di consegna (acquisto, conto deposito, reso); 
* Modificato il paragrafo “7.1.2. Dettaglio sui Dispositivi Medici e loro identificazione - Codice UDI” in virtù dell’aggiunta del nuovo campo cac:ItemInstance/cbc:ProductTraceID per indicare il codice UDI dei dispositivi medici. 
...
* Aggiunti nuovi valori per identificare il Net Volume e il Net Weight nella codelist Measured attribute code for despatch advice (UNCL6313 Subset); 
* Aggiunta nuova codelist ProductTraceIDschemeID da utilizzare per il campo cbc:ProductTraceID; 
* Aggiunta nuova codelist Despatch advice type code (UNCL1001 subset) da utilizzare per il campo cbc:DespatchAdviceTypeCode; 
* Electronic Address Scheme (EAS)
** Rimossi: 9901
** Aggiunti: 0147,0154,0158,0170,0194,0203,0205,0217,0225,0240
* ISO 6523 ICD list
** Aggiunti: 0239,0240 
* ISO 4217 Currency codes 
** Rimossi: CUC,ZWL 
