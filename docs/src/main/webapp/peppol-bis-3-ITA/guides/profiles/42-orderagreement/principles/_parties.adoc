...
I ruoli che possono essere ricoperti dal Cliente sono: acquirente, consegnatario/destinatario, #debtor, contracting body#.


|*Fornitore (Cedente)*
|Il fornitore è la persona giuridca o organizzazione che fornisce un prodotto o servizio. 

I ruoli che possono essere ricoperti dal Fornitore sono: venditore, speditore, #creditor, economic operator#.
|====
