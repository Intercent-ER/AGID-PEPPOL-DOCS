...
#Quando la fattura si riferisce ad un unico Documento di Trasporto, la data del DDT viene riportata nel *cbc:ActualDeliveryDate* (BT-72 Actual delivery date).#


include::../../syntax/delivery.adoc[]

include::ext-vettore.adoc[]

include::ext-ritiro-merce.adoc[]

include::ext-spedizione.adoc[]