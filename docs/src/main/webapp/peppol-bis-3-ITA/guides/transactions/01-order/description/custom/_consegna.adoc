...
Il Cliente può indicare al Fornitore il livello di piorità richiesta nell'evasione dell'ordine valorizzando il campo "ShippingPriorityLevelCode" dell'elemento "Shipment", inserendo il relativo codice tra quelli presenti nella codelist "Transport service priority code (UNCL4219)" come mostrato nell'esempio.
