...
* *9906* per le partite IVA

* *9907* per i Codici Fiscali di persona fisica o giuridica

* *0201* per il Codice Univoco Ufficio (c.d. "Codice iPA", fornita nella rubrica dell'Indice delle Pubbliche Amministrazioni) +
