...
* #un insieme di CIUS ed estensioni della Core Invoice atte a rendere equipollente il contenuto di una fattura elettronica redatta secondo queste specifiche con il formato italiano FatturaPA.#

#In questo documento le regole d’uso ed i paragrafi derivanti dal modello italiano di eProcurement sono evidenziate in giallo, con specifica evidenza:#

* #delle CIUS da applicare alle fatture cross-border;#
...
#Per ulteriori dettagli vedi anche i paragrafi 12.2 e 14.1.#
