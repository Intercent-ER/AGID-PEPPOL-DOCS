...
Il cliente può essere una PA, [lime]#un operatore economico, un cittadino o un soggetto residente, non residente, non stabilito/identificato in Italia.#
...
[lime]#Il Codice EORI può essere espresso nell'elemento *cac:PartyIdentification/cbc:ID* omettendo l'attributo @schemeID ma includendo il prefisso "EORI:" come nell'esempio di seguito.#
